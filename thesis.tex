...
\keywords{Reinforcement Learning, Neuro-symbolic, Neuro-symbolic Concept Learner, Multi-task Reinforcement Learning, Robotics}
...
\nomenclature{NeSy}{Neuro-Symbolic}
\nomenclature{NS-CL}{Neuro-Symbolic Concept Learner}
\nomenclature{NSRL}{Neuro-Symbolic Reinforcement Learning}
\nomenclature{UART}{Universal Asynchronous Receiver/Transmitter}
\nomenclature{USB}{Universal Serial Bus}
\nomenclature{RAMPS}{RepRap Arduino Mega Pololu Shield}
% \nomenclature{$\mu$C}{Microcontroller}
